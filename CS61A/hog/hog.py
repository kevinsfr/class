...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while (score0<goal) and (score1<goal):
        if who==0:
            ...
            if x==0:
                score0=score0+take_turn(x,score1,six_sided)
            else:
                score0=score0+roll_dice(x,select_dice(score0,score1))
        else:
            x=strategy1(score1,score0)
            if x==0:
                score1=score1+take_turn(x,score0,six_sided)
            else:
                score1=score1+roll_dice(x,select_dice(score1,score0))
...
def max_scoring_num_rolls(dice=six_sided):
    ...
    while x<10:
        x=x+1
        s=make_averaged(roll_dice)(x,dice)
        if s>max:
            max=s
            maxx=x
    return maxx
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    NUM_ROLLS otherwise.
    """
    x=abs(opponent_score//10-opponent_score%10)+1
    if (score+x)*2==opponent_score:
        return 0
    elif (score+x)//2==opponent_score:
        return num_rolls
    else: 
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    "*** YOUR CODE HERE ***"
    x=abs((opponent_score//10)-(opponent_score%10))+1
    if (select_dice(score+x,opponent_score)==four_sided) or ((score+x)*2==opponent_score):
        return 0
    elif ((select_dice(score+1,opponent_score)==four_sided)) or ((score+1)*2==opponent_score):
        return 10
    else:
        return max_scoring_num_rolls(select_dice(score,opponent_score))
