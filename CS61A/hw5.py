...
def shuffle(cards):
    ...
    i=0
    while i<half:
        new_cards=new_cards+[cards1[i]]+[cards2[i]]
        i+=1
    return new_cards
...
def has_61A_gene(dna):
    ...
    """
    "*** YOUR CODE HERE ***"
    cs61a_dna=link('C', link('A', link('T', link('C', link('A', link('T', empty))))))
    return has_sublist(dna,cs61a_dna)
