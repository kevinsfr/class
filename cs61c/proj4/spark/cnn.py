...
class CNNClassifier(Classifier):
  ...
  def forward(self, data):
    ...
    #return data.map(lambda (k, (x, y)): (k, (x, 
    #  [conv_forward(x, A1, b1, S1, P1),
    ...
    #   linear_forward(max_pool_forward(ReLU_forward(conv_forward(max_pool_forward(ReLU_forward(conv_forward(max_pool_forward(ReLU_forward(conv_forward(x, A1, b1, S1, P1)[0]), F3, S3)[0], A4, b4, S4, P4)[0]), F6, S6)[0], A7, b7, S7, P7)[0]), F9, S9)[0], A10, b10)
    #  ], y)))
